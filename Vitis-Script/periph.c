...
//  InstancePtr->TpgPtr   = &Tpg;
  ...
  //TPG XPAR_V_TPG_SS_0_V_TPG_DEVICE_ID
  //status = XV_tpg_Initialize(InstancePtr->TpgPtr, XPAR_V_TPG_0_DEVICE_ID);
//  status = XV_tpg_Initialize(InstancePtr->TpgPtr, XPAR_V_TPG_SS_0_V_TPG_DEVICE_ID);
...
//  }
  ...
  //VTC
  VtcConfigPtr = XVtc_LookupConfig(XPAR_V_HDMI_TXSS1_V_TC_DEVICE_ID);
