...
typedef enum {
    ...
    */
...
#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*TogglePipZoom)();
#endif


#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetPipStreamWindow)(XVidC_VideoWindow input_win);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetZoomStreamWindow)(XVidC_VideoWindow input_win);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetBGColor)(XLboxColorId bg_color_id);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetSaturation)(int val, int set);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetContrast)(int val, int set);
#endif


#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetPictureGain)(int val, int ch, int set);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetPictureStandard)(int val, int set);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetPictureColorRange)(int val, int set);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetPictureDemoWindow)(XVidC_VideoWindow input_win);
#endif


#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetBrightness)(int val, int set);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*GetStreamWindow)();
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*GetIOColorFormat)();
#endif



#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*DisableMixer)(int  layerIndex);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetLayerAlpha)(int  layerIndex, int alpha_val);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*SetScaleFactor)(int  layerIndex, int scaleFactor);
#endif

#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
    typedef void (*EnableMixer)(int  layerIndex);
#endif
#ifdef XPAR_XV_HDMITXSS1_NUM_INSTANCES
	...
	TogglePipZoom TogglePipZoomCB;
	SetPipStreamWindow SetPipStreamWindowCB;
	SetZoomStreamWindow SetZoomStreamWindowCB ;
	GetStreamWindow GetStreamWindowCB ;
	SetBGColor SetBGColorCB;
	EnableMixer EnableMixerCB;
	DisableMixer DisableMixerCB ;
	SetLayerAlpha SetLayerAlphaCB ;
	SetScaleFactor SetScaleFactorCB ;
	GetIOColorFormat GetIOColorFormatCB ;
	UpdateWindow UpdateWindowCB ;
	SetBrightness SetBrightnessCB;
	SetContrast SetContrastCB;
	SetSaturation SetSaturationCB ;
	SetPictureGain SetPictureGainCB;
	SetPictureStandard SetPictureStandardCB;
	SetPictureColorRange SetPictureColorRangeCB;
	SetPictureDemoWindow SetPictureDemoWindowCB;
